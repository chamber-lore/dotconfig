...
// user_pref("browser.search.separatePrivateDefault", true); // [FF70+] just using SearX for both
...
//
// Enable RFP
// user_pref("privacy.resistFingerprinting", true); // [FF41+] using CanvasBlocker instead
...
// user_pref("dom.webaudio.enabled", false); // CanvasBlocker discourages this
...
user_pref("remote.force-local", false);
